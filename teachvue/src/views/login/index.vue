        ...
        if (valid) {
          ...
          loginApi.login(this.loginForm).then(function (result) {
            if (result && result.code === 1) {
              _this.$store.dispatch('user/initUserInfo')
...
.login-container {
  .el-input {
    ...
    input {
      ...
      &:-webkit-autofill {
        box-shadow: 0 0 0px 1000px #e6e7e9 inset !important;
